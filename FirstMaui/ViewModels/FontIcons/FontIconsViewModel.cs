...
namespace FirstMaui.ViewModels.FontIcons;
public class FontIconsViewModel : BaseViewModel
{
    ...
    void CreateIconCollection()
    {
        ...
        {
            new FontIconGroupModel( "FirstMaui Icons", (List<FontIconModel>)mauiKit) ,
    ...
    public readonly IList<FontIconModel> mauiKit =
        typeof(FirstMauiIcons).GetFields()
            .Select(x => new FontIconModel
            {
                Type = "FirstMaui Icons",
                Name = x.Name,
