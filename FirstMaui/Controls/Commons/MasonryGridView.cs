...
namespace FirstMaui.Controls
{
    ...
    /// </summary>
    public class MasonryGridView : Layout<View>
    {
        ...
        public static readonly BindableProperty ItemWidthProperty =
            BindableProperty.Create(nameof(ItemWidth), typeof(double), typeof(MasonryGridView), double.NaN,
                BindingMode.TwoWay, propertyChanged: (bindable, oldvalue, newvalue) => ((MasonryGridView)bindable).OnItemWidthOrHeightChanged(bindable, oldvalue, newvalue));
        ...
        public static readonly BindableProperty ItemHeightProperty =
            BindableProperty.Create(nameof(ItemHeight), typeof(double), typeof(MasonryGridView), double.NaN,
                BindingMode.TwoWay, propertyChanged: (bindable, oldvalue, newvalue) => ((MasonryGridView)bindable).OnItemWidthOrHeightChanged(bindable, oldvalue, newvalue));
        ...
        public static readonly BindableProperty MaximumRowsOrColumnsProperty =
            BindableProperty.Create(nameof(MaximumRowsOrColumns), typeof(int), typeof(MasonryGridView), -1,
                BindingMode.TwoWay, propertyChanged: (bindable, oldvalue, newvalue) => ((MasonryGridView)bindable).OnMaximumRowsOrColumnsChanged());
        ...
        public static readonly BindableProperty OrientationProperty =
            BindableProperty.Create(nameof(Orientation), typeof(StackOrientation), typeof(MasonryGridView), StackOrientation.Horizontal,   
                BindingMode.TwoWay, propertyChanged: (bindable, oldvalue, newvalue) => ((MasonryGridView)bindable).OnOrientationChanged(bindable, oldvalue, newvalue));
        ...
        public static readonly BindableProperty RowSpanProperty =   
            BindableProperty.Create("RowSpan", typeof(int), typeof(MasonryGridView), 1);
        ...
        public static readonly BindableProperty ColumnSpanProperty =
            BindableProperty.Create("ColumnSpan", typeof(int), typeof(MasonryGridView), 1);
