...
namespace FirstMaui.Controls.Charts.LiveChart;
public class CustomLegend : IChartLegend<SkiaSharpDrawingContext>
{
    ...
    private readonly SolidColorPaint _fontPaint = new(new SKColor(50, 50, 50))
    {
        SKTypeface = SKTypeface.FromFamilyName("Courier New", SKFontStyle.Bold),
        ZIndex = s_zIndex + 1
    };
